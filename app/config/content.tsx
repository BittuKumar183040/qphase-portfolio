...
export const navItems: NavItem[] = [
  ...
  { id: "fidelity-model", label: "Proof Point · The Fidelity Model" },
  { id: "data", label: "Data · Measured, Not Modeled" },
  { id: "cross-platform", label: "Proof Point · Cross-Platform" },
  { id: "partner", label: "What a Partner Gets" },
  { id: "status", label: "Status and the Ask" },
];
...
export const approach = {
  ...
  pullquote:
    "We call it the Invariant Broker. It's the one piece of this pitch that isn't a number — it's a discipline the rest of the deck is evidence for.",
  footnote: ["Higher confidence", "Real advantage"],
};
...
export const verification = {
  ...
  stats: [
    { value: "13/13", label: "Broker-verified vs. real IBM emulation" },
    { value: "0.934", label: "Mean fidelity agreement across circuits" },
    { value: "4–10", label: "Qubit range actually measured" },
    { value: "4,096", label: "Shots per circuit, every run" },
  ],
};

export const fidelityModel = {
  ...
  comparison: [
    { label: "Naive formula predicted", value: "0.36" },
    { label: "Measured on hardware emulation", value: "0.88" },
    { label: "Size of the miss", value: "2.4×" },
  ],
};
...
export const dataSection = {
  ...
  logRows: [
    { key: "Device model", value: "ibm_torino (127q), calibration pinned per run" },
    { key: "Shots", value: "4,096 per circuit" },
    { key: "Comparator", value: "IBM Qiskit Aer noise-model emulator" },
    { key: "Reported", value: "Fidelity, ⟨H⟩ drift, entanglement entropy, error bound" },
  ],
};
...
export const crossPlatform = {
  ...
  backends: [
    { name: "IBM", detail: "127-qubit superconducting, verified" },
    { name: "Rigetti", detail: "Superconducting, verified" },
    { name: "Google", detail: "Superconducting, verified" },
    { name: "IonQ", detail: "Trapped ion, verified" },
    { name: "Pasqal", detail: "Neutral atom, verified" },
    { name: "QuEra", detail: "Neutral atom, verified" },
    { name: "Photonic", detail: "5-qubit ceiling disclosed upfront" },
  ],
};
...
export const statusAndAsk = {
  ...
  status: [
    { label: "IBM", value: "Validated" },
    { label: "Rigetti", value: "In progress" },
    { label: "IonQ", value: "In progress" },
    { label: "Photonic", value: "5-qubit, disclosed" },
  ],
};
