...
export default function QphasePipeline() {
  return (
    <section className="relative flex w-full min-h-dvh flex-col justify-center bg-white px-6 py-24 text-black dark:bg-black dark:text-white sm:px-5 md:px-10 lg:px-20">
